...
def ph_annual_extractor(file_loc, data_year):
    ...
    grapher(xDataTrueNO, extractedData.get("Temp"), extractedData.get("pH"), extractedData.get("Battery"), 
            str(data_year) + " pH Data (No Outliers) Annual")
    ...
    grapher(xDataTrueO, tyData, pyData, byData, str(data_year) + " pH Data (With Outliers) Annual")
...
ph_annual_extractor("SAMI_pH\\pH_Annual_Compiled_Data\\pH_2022_Complete_Data.csv", 2022)
