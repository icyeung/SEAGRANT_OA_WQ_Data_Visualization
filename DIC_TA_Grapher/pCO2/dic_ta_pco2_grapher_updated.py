...
MWRA_fitted_data = commonDataRange_MWRA(MWRA_trunc_df, "01-01-2021", "12-31-2021")
...
NOAA_fitted_data = commonDataRange_NOAA(NOAA_data, "01-01-2021", "12-31-2021")
...
ax4 = ax1.twinx()
p8 = ax4.scatter(incoming_time_list, incoming_list, color = "k", marker = "+", label = "Incoming Tide")
p9 = ax4.scatter(outgoing_time_list, outgoing_list, color = "k", marker = "_", label = "Outgoing Tide")
