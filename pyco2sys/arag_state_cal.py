...
def arag_state_cal(sami_type, sami_file_loc, arag_file_save_name):
    ...
    Ar_pred_DIC_ORI = co2sysORI["saturation_aragonite_out"]
        
    #print(Ar_pred_DIC_ORI)

    sami_file["Saturation Aragonite Out"] = Ar_pred_DIC_ORI
    ...
    Ar_pred_DIC_v2 = co2sysv2["saturation_aragonite_out"]
        
    #print(Ar_pred_DIC_ORI)

    sami_file["Saturation Aragonite Out (MCHP73)"] = Ar_pred_DIC_v2


    co2sysv3 = PyCO2SYS.sys(
        par1_type=1,  # Total Alkalinity input 1
        par1=sami_file['TA (Approximated)'],
        par2_type=par2_type_set,  # pH/pCO2 depending on what the sami measures
        par2=par2_set,
        ...
        opt_pH_scale = 4, # NBS 4
        opt_k_carbonic = 5, # H73a, H73b and MCHP73 refit by DM87
        opt_k_bisulfate = 1, # D90a: Dickson et al 1990 (J. Chem. Therm.) 1
        opt_total_borate = 2, # LKB10: Lee et al 2010 2
        opt_k_fluoride = 1 # DR79: Dickson and Riley 1979 1
    )

    Ar_pred_DIC_v3 = co2sysv3["saturation_aragonite_out"]
        
    #print(Ar_pred_DIC_ORI)

    sami_file["Saturation Aragonite Out (H73a,H73b,MCHP73)"] = Ar_pred_DIC_v3


    co2sysv4 = PyCO2SYS.sys(
        par1_type=1,  # Total Alkalinity input 1
        par1=sami_file['TA (Approximated)'],
        par2_type=par2_type_set,  # pH/pCO2 depending on what the sami measures
        par2=par2_set,
        ...
        opt_pH_scale = 4, # NBS 4
        opt_k_carbonic = 4, # MCHP73 refit by DM87
        opt_k_bisulfate = 1, # D90a: Dickson et al 1990 (J. Chem. Therm.) 1
        opt_total_borate = 2, # LKB10: Lee et al 2010 2
        opt_k_fluoride = 1 # DR79: Dickson and Riley 1979 1
    )

    Ar_pred_DIC_v4 = co2sysv4["saturation_aragonite_out"]
        
    #print(Ar_pred_DIC_ORI)

    sami_file["Saturation Aragonite Out (MCHP73 refit)"] = Ar_pred_DIC_v4


    co2sysv5 = PyCO2SYS.sys(
        par1_type=1,  # Total Alkalinity input 1
        par1=sami_file['TA (Approximated)'],
        par2_type=par2_type_set,  # pH/pCO2 depending on what the sami measures
        par2=par2_set,
        ...
        opt_pH_scale = 4, # NBS 4
        opt_k_carbonic = 1, # RRV93
        opt_k_bisulfate = 1, # D90a: Dickson et al 1990 (J. Chem. Therm.) 1
        opt_total_borate = 2, # LKB10: Lee et al 2010 2
        opt_k_fluoride = 1 # DR79: Dickson and Riley 1979 1
    )

    Ar_pred_DIC_v5 = co2sysv5["saturation_aragonite_out"]
        
    #print(Ar_pred_DIC_ORI)

    sami_file["Saturation Aragonite Out (RRV93)"] = Ar_pred_DIC_v5
