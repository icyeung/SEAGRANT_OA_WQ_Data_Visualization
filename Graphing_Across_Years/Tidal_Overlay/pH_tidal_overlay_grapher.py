...
NOAA_tidal_data = pd.read_csv(os.path.join(__location__, "NOAA_Tidal_HL_2022_Dennisport_GMT.csv"))
...
p1 = ax1.plot(pH_date_revised, pH_data, color = "b", linestyle = 'solid', label = '2022', linewidth=0.75)
...
plt.title("pH & High/Low Tidal Markers (2022)", loc='center')
plt.grid(True)
plt.legend()
...
plt.savefig(my_path + '\\pH_tidal_overlay_oct_2022_Graph_No_Outliers.png')
