...
NERACOOS_data = pd.read_csv("C:\\Users\\isabe\\source\\repos\\icyeung\\SAMI_Data_SeaGrant\\Conductivity\\Sourced_Data\\NERACOOS_Data\\NERACOOS_Waquoit_Bay_Data\\NERACOOS_Waquoit_Salinity_2020.csv")
...
NERACOOS_fitted_data = commonDataRange_NERACOOS(NERACOOS_data, "01-01-2020", "12-31-2020")
...
p1 = ax1.scatter(NERACOOS_fitted_data["Datetime"], NERACOOS_fitted_data["WAXM31m-Hourly-Salinity_psu"], 5, color = 'blue', marker = "o", label = 'NERACOOS Salinity')
...
plt.title("NERACOOS Waquoit Bay (WAXM3) 2020 Salinity Outliers Removed", loc='center')
...
plt.savefig(my_path + '\\Conductivity_Graphs\\NERACOOS_Graphs\\NERACOOS_Salinity_2020_Waquoit_WAXM3_No_Outliers.png')
plt.show()