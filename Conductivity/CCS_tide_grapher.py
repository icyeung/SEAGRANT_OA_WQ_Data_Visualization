...
CCS_fitted_data = commonDataRange_CCS(CCS_data, "01-01-2022", "12-31-2022")
...
p13 = ax2.scatter(CCS_fitted_data["Datetime"], CCS_fitted_data["salinity"], color = 'red', marker = "*", label = 'CCS Salinity')
...
plt.title("CCS Harwich (Herring River-Station 124) Salinity 2022 with Tide", loc='center')
