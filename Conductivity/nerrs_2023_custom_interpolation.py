...
def nerrs_custom_interpolation(break_start_day, break_end_day, adjustment_start_day):
    ...
    nerrs_data.to_csv("C:\\Users\\isabe\\OneDrive\\Documents\\Code\\MITSG_OA_WQ\\nerrs_2023_empty_sal_rows_added_mean_week_test.csv", index=False)


    nerrs_data2 = nerrs_data.copy()

    seasonal_variation_part1 = pd.read_csv("C:\\Users\\isabe\\OneDrive\\Documents\\Code\\MITSG_OA_WQ\\NERRS_2023_Part1_Metoxit_MSTL_Seasonal_Component_Table.csv")
    ...
    plt.savefig("C:\\Users\\isabe\\OneDrive\\Documents\\Code\\MITSG_OA_WQ\\nerrs_2022_custom_interpolated_salinity_test_week_mean.png")

    plt.show()


nerrs_custom_interpolation(datetime.datetime(2022, 6, 25, 00, 45), datetime.datetime(2022, 7, 31, 17, 00), datetime.datetime(2022, 6, 16, 23, 30))
