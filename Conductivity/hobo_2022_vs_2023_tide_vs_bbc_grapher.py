...
p2 = ax1.plot(hobo_date_no_year, hobo_sal, color = "b", linestyle = 'solid', label = 'HOBO #1 2022 (+15 PSU)', linewidth=0.75)
...
# Graphs BBC Data
ax3 = ax1.twinx()
p3a = ax3.scatter(NOAA_date_high_revised, NOAA_data_high, color = 'g', marker = "*", label = 'Pocasset River Entrance- 2023 High Tide')
p3b = ax3.scatter(NOAA_date_low_revised, NOAA_data_low, color = 'r', marker = "^", label = 'Pocasset River Entrance- 2023 Low Tide')
...
plt.title("HOBO #1 2022 (-3 Hours) vs Pocasset River Entrance 2023 High/Low Tidal Markers vs BBC PR1", loc='center')
plt.grid(True)
plt.legend()
...
plt.savefig(my_path + '\\Conductivity_Graphs\\Comparison_Graphs\\hobo_1_2022_vs_2023_pocasset_tide_vs_bbc.png')
