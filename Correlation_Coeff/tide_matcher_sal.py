...
salinity_df = pd.read_csv('C:\\Users\\isabe\\source\\repos\\icyeung\\SAMI_Data_SeaGrant\\Correlation_Coeff\\wqbmpwq2022_adjusted_UTC+1.csv', parse_dates=['DateTimeStamp'])
...
salinity_df['time_column'] = pd.to_datetime(salinity_df['DateTimeStamp'])
...
matched_df.to_csv('NERRS_MP_2022_Matched_Tide.csv', index=False)
