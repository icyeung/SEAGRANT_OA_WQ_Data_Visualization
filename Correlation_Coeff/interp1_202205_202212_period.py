...
df_withtide_unsampled = pd.read_csv(my_path + '\\NERRS_MP_2022_Matched_Tide_Updated.csv')

df_withtide_unsampled["Datetime"] = pd.to_datetime(df_withtide_unsampled["Salinity_Time"])

df_withtide = df_withtide_unsampled.sample(frac=0.5, random_state=42)
...
full_range = pd.date_range(start="2022-05-12 16:30:00", end="2022-12-20 18:30:00", freq="15T")
...
plt.savefig(my_path + '\\NERRS_interp_test_50percmissing_3order_poly_2022512_20221220.png')
