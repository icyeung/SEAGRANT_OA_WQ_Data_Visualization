...
df_withtide_unsampled = pd.read_csv(my_path + '\\NERRS_test_data_trunc_082022.csv')
...
full_range = pd.date_range(start="2022-08-15 03:30:00", end="2022-08-25 23:45:00", freq="15T")
...
plt.savefig(my_path + '\\NERRS_interp_test_3order_poly_2022815_2022825.png')
