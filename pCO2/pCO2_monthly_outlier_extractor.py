...
def pco2_monthly_outlier_extractor(file_loc, data_year):
    ...
    grapher(xDataTrueNO, extractedData.get("Temp"), extractedData.get("CO2"), extractedData.get("Battery"), 
            str(data_year) + " pCO2 Data (No Outliers) Monthly")
    ...
    grapher(xDataTrueO, tyData, cyData, byData, str(data_year) + " pCO2 Data (With Outliers)")
...
pco2_monthly_outlier_extractor('SAMI_pCO2\\pCO2_Annual_Compiled_Data\\pCO2_2018_Complete_Data.csv', 2018)
